<template>
     <div class="row">
        ...
        <div class="col-md-12 mt-2"> <h5 class="d-inline label">Página web del negocio </h5><br><a :href="'/empresa/'+form.nombre_unico" class="enlace">www.teloenvio.com/empresa/{{form.nombre_unico}}</a></div>
     </div>
</template>
